const CACHE='wordbound-whispering-woods-v1';
const SHELL=['./','./index.html','./manifest.webmanifest','./css/wordbound.css','./js/wordbound/data.js','./js/wordbound/engine.js','./js/wordbound/app.js','./js/wordbound/safety.js','./assets/wordbound-mark.svg','./assets/whispering-woods.svg'];
