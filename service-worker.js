...
const SHELL=['./','./index.html','./manifest.webmanifest','./css/wordbound.css','./js/wordbound/data.js','./js/wordbound/engine.js','./js/wordbound/app.js','./assets/wordbound-mark.svg','./assets/whispering-woods.svg'];
